...
export default function AdvertisersPage() {
  ...
  const handleFilterChange = (filterKey: "plan" | "status", value: string) => {
    setFilters((prev) => ({ ...prev, [filterKey]: value }));
  };

  const getFilterLabel = (filterKey: "plan" | "status") => {
    const options = filterKey === "plan" ? PLAN_OPTIONS : STATUS_OPTIONS;
    return (
